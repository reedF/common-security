...
public class AES {
	 ...
	 * * 生成密钥 *
	 * </p>
	 * * * @param seed 密钥种子 * @return * @throws Exception
	 */
	...
	public static String encrypt2String(String data, String key)
			throws Exception {
	 ...
	 * * 文件加密 *
	 * </p>
	 * * * @param key * @param sourceFilePath * @param destFilePath * @throws
	 * Exception
	 */
	...
	public static String decrypt2String(String data, String key)
			throws Exception {
		return new String(decrypt(data.getBytes(), key));
	}
